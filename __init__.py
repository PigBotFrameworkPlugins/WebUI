...
def _enter():
    ...
    def get_current_username(
        ...
        correct_username_bytes = config.plugins_config.get("webui", {}).get("basic_auth", {}).get("username", "admin").encode("utf8")
        is_correct_username = secrets.compare_digest(
            current_username_bytes, correct_username_bytes
        )
        current_password_bytes = credentials.password.encode("utf8")
        correct_password_bytes = config.plugins_config.get("webui", {}).get("basic_auth", {}).get("password", "admin").encode("utf8")
